...
import com.example.turf.model.BookedTurf;  // Changed to BookedTurf
...
import com.example.turf.service.ITurfService;  // Interface for Turf services
...
public class BookingService implements IBookingService {
    ...
    private final ITurfService turfService;  // Change reference to TurfService


    @Override
    public List<BookedTurf> getAllBookings() {
        return bookingRepository.findAll();
    }

    @Override
    public List<BookedTurf> getBookingsByUserEmail(String email) {
